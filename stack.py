...
# 1.2 queue
# 1.3 queue
# 2. queue - 1) waiting in line at a store, 2) completing a todo list by due date
# 3. stack - 2) sales clerk stocking items on a shelf, boxes stacked on top of each other
